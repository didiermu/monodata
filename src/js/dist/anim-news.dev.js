...
var objParallaxText = function objParallaxText(trigger, elem, posicion) {
...
objParallaxText(".grid__item", ".grid__item .col-lg-6", -20); //////////////////////// CLASS BODY

if (window.location.pathname.includes("noticias")) {
  document.querySelector("body").classList.add("body-news");
}
//# sourceMappingURL=anim-news.dev.js.map
